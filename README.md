...
This project uses [UV](https://docs.astral.sh/uv/) for dependency management and follows UV best practices for FastAPI applications.
...
This project follows UV best practices for FastAPI applications:
...
│   └── papermage_docling/       # Core functionality
...
```bash
docker build -t semantic-reader-backend .
```

Run the Docker container:
```bash
docker run -p 8000:8000 semantic-reader-backend
```
